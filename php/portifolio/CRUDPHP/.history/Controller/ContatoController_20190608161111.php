...
$mail->Host = "smtp.office365.com"; // Você pode alterar este parametro para o endereço de SMTP do seu provedor
$mail->Port = 587; 
...
$mail->AddAddress('bruno.oliveira150@fatec.sp.gov.br', 'Bruno');
