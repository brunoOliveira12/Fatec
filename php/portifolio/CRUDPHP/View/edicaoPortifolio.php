            ...
            <div class="container">                    
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form class="form-horizontal" action="../Controller/PortifolioController.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nome_disciplina" value="<?php echo $resultado->nome_disciplina; ?>" type="text" required>                                
                            </div>
                            <div class="form-group">
                                <label for="grade_disciplina">Grade</label>
                                <input name="grade_disciplina" value="<?php echo $resultado->grade_disciplina; ?>" type="text" required>                                
                            </div>
                            <div class="form-group">
                                <label for="nome_professor">Professor</label>
                                <input name="nome_professor" value="<?php echo $resultado->nome_professor; ?>" type="text" required>                                
                            </div>
