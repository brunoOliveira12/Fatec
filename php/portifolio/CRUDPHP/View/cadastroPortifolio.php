            ...
            <div class="container">                    
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form class="form-horizontal" action="../Controller/PortifolioController.php" enctype="multipart/form-data" method="POST">
                            <div class="form-group">
                                <label for="nome_disciplina">Disciplina</label>
                                <input name="nome_disciplina" type="text" required>                                
                            </div>
                            <div class="form-group">
                                <label for="grade_disciplina">Grade</label>
                                <input name="grade_disciplina" type="text" required>                                
                            </div>
                            <div class="form-group">
                                <label for="nome_professor">Professor</label>
                                <input name="nome_professor" type="text" required>                                
                            </div>
                            <div class="form-group">
