                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <form class="form-horizontal" action="../Controller/PessoaController.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id" readonly="false" value="<?php echo $resultado->id; ?>">                                                               
                            </div>
                            <div class="form-group">
                                <label for="nome">Nome</label>                                
                                <input type="text" name="nome"  readonly="false" value="<?php echo $resultado->nome; ?>" placeholder="Nome:"/>                                
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" name="email"  readonly="false" value="<?php echo $resultado->nome; ?>" placeholder="E-mail:"/>
                            </div>                                             
                            <?php
                            session_start();
