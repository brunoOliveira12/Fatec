            ...
            <div class="container">                    
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form class="form-horizontal" action="../Controller/ProdutoController.php" method="POST">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nome_produto" value="<?php echo $resultado->nome_produto; ?>" type="text" required readonly="true">                                
                            </div>
                            <div class="form-group">
                                <label for="valor_produto">Valor</label>
                                <input name="valor_produto" value="<?php echo $resultado->valor_produto; ?>" type="number" required readonly="true">                                
                            </div>
                            <div class="form-group">
                                <label for="nome_vendedor">Vendedor</label>
                                <input name="nome_vendedor" value="<?php echo $resultado->nome_vendedor; ?>" type="text" required readonly="true">                                
                            </div>                         
                            </div>                            
                            <div class = "col-sm-8 col-md-2">
                            <div class = "thumbnail">
                                <img src ="<?=$resultado->caminho_produto?>">
                            </div>
                            </div>
                            </div>
                            <?php               
